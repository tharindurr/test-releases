...
const { PrereleasePatchVersionUpdate } = require('release-please/build/src/versioning-strategies/prerelease')
...
async function main () {
  ...
  registerVersioningStrategy('devel', () => {
    class _OnlyDevel {
      bump (version, commits) {
        return this.determineReleaseType(version, commits).bump(version)
      }
      ...
      determineReleaseType (version, commits) {
        ...
        return {
          bump: (version) => {
            if (!version) {
              return new Version(0, 1, 0, `${PRERELEASE_NAME}.0`, null)
            }
            return new Version(
              version.major,
              version.minor,
